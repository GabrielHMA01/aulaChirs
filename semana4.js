...
class NewCar extends Car {
  ...
  ofertaEspecial() {
    console.log(`Aproveite nossa oferta especial para o novo ${this.marca} ${this.modelo}! Por apenas R$ ${this.preco - 100000}, além disso você leva o carro com ${this.garantia} de garantia`)
  }
}
